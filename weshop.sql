...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2021 at 01:57 AM
...
(8, 1, 'Iphone X 256 GB', '<p><strong>SPESIFIKASI IPHONE X</strong></p><p>BODI : Unibodi 143.6 x 70.9 x 7.7 mm 174 gram</p><p>SIM : Single SIM</p><p>JARINGAN : 2G, 3G HSDPA, 4G LTE, VoLTE</p><p>LAYAR OLED Super Retina HD 5.8 inchi 1125 x 2436 piksel ~458 ppi</p><p>FITUR LAYAR : 3D touch, Fingerprint resistant, Wide color, True tone &amp; HDR display</p><p>MEMORI : 64/256 GB Tanpa slot SD card</p><p>RAM : 3 GB</p><p>SISTEM OPERASI : IOS 11</p><p>PROSESOR : Hexa-core Appe A11 Bionic 64 bit</p><p>GPU : Apple GPU (3 core)</p><p>KAMERA DEPAN : 7 MP f/2.2</p><p>FITUR : Potrait mode, potrait lighting, animoji, retina flash,Body &amp; Face detection, HDR, exposure control, Video 1080p</p><p>KAMERA BELAKANG : Dual 12 MP (Wide f/1.8 &amp; Telephoto f/2.4)</p><p>FITUR : Optical zoom, Digital zoom upto 10x, potrait mode, potrait lighting, Dual OIS, Quad LED Flash, Panorama (upto 63 MP), Shappire crystal lens cover, hybrid IR filter, Autofocus, Noise reduction, manual mode, busrt mode, HDR</p><p>VIDEO : 4K@24/30/60fps,&nbsp;1080p@30/60fps,&nbsp;720p@30fps, OIS Video, Optical zoom, slow-motion video&nbsp;1080p@120/240fps, time lapse mode</p><p>KONEKTIVITAS : USB ,Wi-fi, hotspot, Bluetooth, GPS, NFC</p><p>SENSOR : Face ID, Gyro, barometer, accelerometer, proximity, ambient light</p><p>BATERAI : Li-ion non removable, fast charging, wireless charging</p><p>LAINIp67 (Tahan air dan debu) Wi-fi call, Siri</p>', 'ipx.png', 11000000, 3, 'off'),
...
(5, 1, 6, 'jeong', '8888', 'jl.jalan', '2019-08-18 16:33:05', 0),
(6, 1, 2, '', '', '', '2019-08-20 16:22:00', 0),
(7, 1, 2, 'iqbalali', '2323', 'jl jalan', '2019-08-23 09:06:02', 0),
(8, 4, 2, 'asu', '088888888888888', 'anjing', '2019-08-26 04:27:27', 0);
...
(7, 'superadmin', 'muhammad iqbal ali', 'admin2@weshop.com', 'jl.jalan', '911', 'f841d24f8a48f1057f22d97bf12fcce5', 'on');
